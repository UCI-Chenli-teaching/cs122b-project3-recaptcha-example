...
3. Get a [reCAPTCHA](https://www.google.com/recaptcha/intro/v3.html) from Google. 
   `Get Started` -> `Register a new site` -> Choose `Challenge (v2): "I'm not a robot" Checkbox` -> Enter both your AWS public IP and "localhost" in "Domains" section -> Click "Submit"
